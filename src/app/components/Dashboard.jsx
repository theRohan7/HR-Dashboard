import { Bell, ChevronDown, Menu, MessageSquareMore, Search } from 'lucide-react'
  ...
  return (
    <div className='dashboard-main'>
        ...
        <div className='dashboard-container' >
            <div className='cards-announcements' ></div>
